...
<div class="SettingCol-header"><div class="SettingCol-contentInner">
	...
	<div class="mtm clearfix">
		<ul class="lfloat SettingCol-headerActions clearfix">
			...
			<li><label class="label" for="country">Country:</label><select id="country" class="inputtext" name="country" style="width: 150px"><?php foreach ($this->countryList as $key => $value) {
				echo '<option value="'.$value['id'].'">'.$value['name'].'</option>';
			} ?></select></li>

			<li><label class="label" for="country">Province:</label><select id="province" class="inputtext" name="province" style="width: 150px" ref="selector"></select></li>
